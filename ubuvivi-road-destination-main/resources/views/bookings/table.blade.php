            ...
            @foreach ($bookings as $booking)
                <tr>
                    ...
                    <td class=" text-center">
                        ...
                        <div class='btn-group'>
                            <a href="{!! route('bookings.show', [$booking->id]) !!}" class='btn btn-light action-btn '><i
                                    class="fa fa-eye"></i></a>
                            <a href="{!! route('bookings.edit', [$booking->id]) !!}" class='btn btn-warning action-btn edit-btn'><i
