...
<head>
    ...
    <title>Welcome - Ubuvivi Tours Newsletter</title>
    <style>
...
<div class="wrap">
    ...
    <div class="body">
        <div class="subject-line">You are now subscribed</div>

        <p>Thank you for subscribing to the Ubuvivi Tours &amp; Travel newsletter.</p>

        <p>You will receive updates on new tours, travel tips, hotel deals, and exclusive offers. We aim to keep our emails relevant and infrequent.</p>
        ...
        <p style="font-size:13px;color:#888;">If you did not subscribe, you can ignore this email. No further action is needed.</p>
    </div>
