...
@section('content')
    ...
    <div style="padding:16px 0 0;">
        <div class="container">
            <a href="{{ route('tour.list') }}" style="display:inline-flex;align-items:center;gap:8px;color:#0D1F35;font-weight:600;font-size:14px;text-decoration:none;background:#f0f4f8;border:1.5px solid #d0d9e4;padding:8px 20px;border-radius:50px;">
                <i class="fas fa-arrow-left" style="font-size:12px;color:#C85A2A;"></i> Go back to Tours
            </a>
        </div>
    </div>
