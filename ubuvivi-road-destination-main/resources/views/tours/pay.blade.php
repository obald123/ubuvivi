        ...
        @else
            <div class="container mb-4">
                <div class="row justify-content-center align-items-center flex-column ">
                    <h2 class="text-center font-primary font-weight-bold">Tour Booking Payment</h2>
                    <h4 class="font-primary font-weight-bold">{{ $booking->tour->title ?? 'Tour not found' }}</h4>
                </div>
            </div>
            {!! Form::open(['route' => ['tour.pay', $booking->id]]) !!}
            <div class="container">
